...
export function AppLoadingState({ label = "Loading data" }: { label?: string }) {
  return (
...
export function AppEmptyState({ title, body, action }: { title: string; body: string; action?: ReactNode }) {
  return (
...
export function AppErrorState({ title = "Something went wrong", body, onRetry }: { title?: string; body: string; onRetry?: () => void }) {
  return (
